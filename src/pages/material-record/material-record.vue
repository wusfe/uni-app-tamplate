    ...
    <view class="bg-#ffffff shrink-0">
      <dropDownBox class="pt-3">
        ...
        <view class="flex pl-5 pr-5 nav-item justify-between">
          ...
          <view class="mr-5 ">
            <dropDownScrollView placeholder="领用状态" :list="range" />
          </view>

          <view >
            <dropDownScrollView placeholder="申请人" :list="range" />
          </view>
        </view>
      </dropDownBox>
    </view>
          ...
          <view class="pt-4 pb-2 pl-4 pr-3 flex">
            <view class="flex flex-col w-100%">
              <view class="flex items-center mb-2">
                ...
                <text>：</text>
                <view class="ml-1"><text class="align-bottom">丁曼容</text></view>
              </view>
              ...
              <view class="flex items-center mb-2">
                ...
                <text>：</text>
                <view class="ml-1"
                  ><text class="align-bottom">2</text></view
                >
              </view>
              ...
              <view class="flex items-center mb-2">
                ...
                <text>：</text>
                <view class="ml-1"
                  ><text class="align-bottom">待领用</text></view
                >
              </view>
