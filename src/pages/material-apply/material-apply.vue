  ...
  <view class="store-purchase ml-3 mr-3 mt-3 pb-4">
    <view class="bg-#ffffff pl-3 pr-3 pt-2 pb-4">
      <uni-forms ref="form" :modelValue="formInput" :rules="rules">
        ...
        <view class="bb1">
          <uni-forms-item required name="unitprice" label="单价" type="digit">
            <uni-easyinput
        ...
        <view class="bb1">
          <uni-forms-item required name="turnoverNumber" label="领用数量">
            <uni-easyinput
              type="number"
        ...
        <view class="bb1">
          <uni-forms-item required name="userId" label="申请人">
            <uni-data-select
...
import { getSysUserUserList, getGoodsinforgoodsCodeList, addGoodsturnover, goodsturnoverOut } from '@/api'
...
const handleConfirm = async () => {
  try {
    ...
    await goodsturnoverOut(formInput.value)
