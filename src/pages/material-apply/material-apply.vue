<template>
  <view class="store-purchase ml-3 mr-3">
    <view class="bg-#ffffff pl-3 pr-3 pt-2 pb-4">
      <uni-forms ref="form">
        <view class="bb1">
          <uni-forms-item required label="物料类型">
            <uni-easyinput
              :inputBorder="false"
              placeholder="请选择物料类型"
        ...
        <view class="bb1">
          <uni-forms-item required label="物料名称">
            <uni-easyinput
              :inputBorder="false"
              placeholder="请选择物料名称"
              style="background-color: transparent"
        ...
        <view class="bb1">
          <uni-forms-item required label="领用数量">
            <uni-easyinput
              :inputBorder="false"
              placeholder="请输入领用数量"
              style="background-color: transparent"
      ...
      <view class="flex mt-5">
        <view class="w-50% mr-5">  <button class="block w-100%" size="mini"  type="primary" plain @click="">重置</button></view>

        <view class="w-50%"> <button  class="block w-100%" type="primary" @click="" size="mini"  >确认</button></view>
      </view>
