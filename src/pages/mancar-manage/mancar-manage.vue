  ...
  <view class="flex flex-col h-100%">
    <view class="shrink-0">
      <view class="flex justify-between items-center bg-#ffffff pt-2 pb-2 pl-3 pr-3">
        <view class="text-color-primary">今日统计：</view>
        ...
        <view v-for="v in data" class="pl-3 pr-3 mt-3">
          ...
          >
            <view class="flex justify-between items-center">
              ...
              <view class="color-gray-4">非危险品车</view>
            </view>

            <view class="flex items-center justify-around mt-4">
              <view class="flex flex-col items-center">
                <view class="w-100rpx h-100rpx bg-#007aff rounded-50% mb-2 flex justify-center items-center">
                  <i class="zhfont zh-icon_shenti_nan color-#ffffff text-56rpx" ></i>
                </view>
                <view class="color-gray-4">254人</view>
              </view>
              <view class="flex flex-col items-center">
                ...
                <view class="color-gray-4">200辆</view>
              </view>
              <view class="flex flex-col items-center">
                <view class="w-100rpx h-100rpx bg-#BF9539 rounded-50% mb-2 flex justify-center items-center">
                  <i class="zhfont zh-qiandai color-#ffffff  text-56rpx"></i>
                </view>
                <view class="color-gray-4">2314.00元</view>
              </view>
            </view>
          </view>
        </view>
