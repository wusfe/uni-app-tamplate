<template>
  <view class="uni-stat__select">
    ...
    <view class="uni-stat-box" :class="{ 'uni-stat__actived': current }">
      <view :class="{'uni-select': true, 'uni-select-focus':showSelector, 'uni-select--disabled': disabled}" >
        ...
        <view class="uni-select__input-box" @click="toggleSelector">
          ...
          <uni-icons class="uni-select-icon" :type="showSelector ? 'top' : 'bottom'" size="14" color="#999" />
        ...
        <view class="uni-select__selector" :style="getOffsetByPlacement" v-if="showSelector">
          ...
          <scroll-view scroll-y="true" class="uni-select__selector-scroll">
            ...
            <view
              v-else
              :class="{'uni-select__selector-item':true, 'uni-select__selector-item__select': current ===  formatItemName(item) }"
...
export default {
  ...
  inject: ['provideRegistrySelect', 'provideHidePup'],
  props: {
    localdata: {
      type: Array,
      default() {
  ...
  methods: {
    ...
    change(item) {
      if (!item.disable) {
        ...
        const current = this.formatItemName(item);
...
.uni-stat__actived {
  ...
  .uni-select__input-text, .uni-select-icon{
